...
std::unique_ptr<CBlockTemplate> CreateNewBlock(const CChainParams& chainparams, int algo, const CScript& scriptPubKeyIn)
{
    // Create new block
...

    {
		...
		// multi-algo: encode algo into nAlgorithm
		pblock->SetAlgo(algo);
